...
def register_form():
    ...
    query_form = "insert into templatemaster (templatename,description,userid)values (" + "'" + val[
        'template_name'] + "'" + "," + "'" + val['description'] + "'" + "," + str(user_id[0][0]) + ");"
    ...
    query_form_id = "select templatemasterid from templatemaster where templatename=" + "'" + val[
        'template_name'] + "'" + ";"
